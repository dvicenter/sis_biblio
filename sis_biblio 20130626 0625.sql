...
-- Script date 26/06/2013 06:25:57 a.m.
...
--
CREATE TABLE IF NOT EXISTS tbl_material_biliografico (
...
BEGIN
    ...
    IF pIdAbm = 0
      THEN 
        SELECT rol, descripcion FROM tbl_rol tbl;
    ELSE
      IF pIdAbm = 1
        THEN
...
INSERT INTO tbl_componente VALUES 
  ...
  (4, 'asdxcfcg', NULL),
  (5, 'kdjfhfjjf', NULL),
  (6, 'karinaa', 'poreeeeeeeee'),
  (7, 'kscksnck', ''),
  (8, 'asdasd', 'nnknknkdsjd'),
  (9, 'dhbsadhbsjhbd', 'jkasklsxkxskcmc');
