...
-- Script date 10/07/2013 05:53:59 p.m.
...
FROM
  sis_biblio.tbl_rol_componente_accion
  INNER JOIN sis_biblio.tbl_rol
    ON tbl_rol_componente_accion.id_rol = tbl_rol.id_rol
  INNER JOIN sis_biblio.tbl_usuario_rol
...
INSERT INTO tbl_escuela VALUES 
  (1, '01', 'INGENIERIA DE SISTEMAS', 'EAPIS', '1', 5),
  (2, '02', 'INGENIERIA INFORMATICA', 'EAPII', '0', 5),
  (3, '03', 'INGENIERIA INDUSTRIAL', 'EAPII', '1', 5),
  (4, '04', 'MEDICINA', 'EAPM', '1', 5),
  (5, '05', 'ENFERMERIA', 'EAPE', '1', 5);
...
INSERT INTO tbl_plan_tesis VALUES 
  ...
  (35, 'PRUEBA 1', 'INTRO PRUEBA', 'OBJETIVO PRUEBA', 'RESUMEN PRUEBA', 'CONCLUSION PRUEBA', '1', NULL, 'prueba@hotmail.com', 1, 5, 1);
