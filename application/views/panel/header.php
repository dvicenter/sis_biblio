<a href="<?php echo base_url();?>"><img style="height: 100%;" src="<?php echo base_url()?>resource\img\header\cabecera.jpg" width="100%" height="100%" alt="UNJFSC-Gestion de Biblioteca Central"></a> 
<ul class="pull-right position_session">
