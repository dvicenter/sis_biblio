...
-- Script date 01/07/2013 11:31:49 p.m.
...
CREATE TABLE IF NOT EXISTS tbl_autor_interno (
  ...
  UNIQUE INDEX id_sujeto (id_sujeto),
...
VIEW viw_sujeto
AS
	select `tbl`.`id_sujeto` AS `id_sujeto`,concat(ifnull(`tbl`.`apellido_paterno`,''),' ',ifnull(`tbl`.`apellido_materno`,''),', ',ifnull(`tbl`.`primer_nombre`,''),' ',ifnull(`tbl`.`segundo_nombre`,'')) AS `sujeto`,`tbl`.`dni` AS `dni`,`tbl`.`email_institucional` AS `email_institucional`,`tbl`.`activo` AS `activo` from `tbl_sujeto` `tbl` where (`tbl`.`activo` = 1);
...
INSERT INTO tbl_componente VALUES 
  (77, 'Cesar Nicho', 'kjasjkdsa'),
  (84, 'asdjlk', ''),
  (86, 'cesar', ''),
  (87, 'lkskjlsdfkjls', 'kljasjlkadskjlsad'),
  (89, '', ''),
  (90, 'hola ', ''),
  (91, '', '');
...
INSERT INTO tbl_sujeto VALUES 
  ...
  (6, '2013-06-12', 'Vicente', 'Rojas', 'Diego', NULL, NULL, NULL, NULL, 'S', 'M', NULL, NULL, NULL, NULL, '0');
...
INSERT INTO tbl_material_bibliografico VALUES 
  (1, '1234', 'TESIS1', 'INTRO1', 'OBJETIVO2', 'RESUMEN3', 'CONCLUSIO4', 2013, NULL, 100, NULL, NULL, NULL, NULL, 1, 2, '1');
...
INSERT INTO tbl_plan_tesis VALUES 
  (2, 'hola', 'hola', 'hola', 'hola', 'hola', '1', NULL, 'asdad', 1, 1, 2),
  (3, 'TESIS', 'SAL', 'POR', 'FS', 'VOR', '1', NULL, 'cesar2010_13@hotmail.com', 2, 3, 2),
  (4, 'cesar', 'adasd', 'asdsad', 'asdsad', 'asdsadsad', '1', NULL, 'cesar2010_13@hotmail.com', 3, 3, 2),
  (5, 'cesar', 'akjskjashdhkjasd', 'lasdlakjsd', 'lkasjdlkasjdlka', 'laksjdlaskjd', '1', NULL, 'cesar2010_13@hotmail.com', 4, 3, 2),
  (28, 'weewewrwe', 'kljsfkjlsdfkjl', 'ldfkkñdfsñksdfkñl', 'ñkldsñkldskñldfsñkl', 'lkjdfskjlfsdkjldfs', '1', NULL, 'c@d.com', 1, 4, 1),
  (29, 'jfidfodkffdlpefkeofj', 'hdshfdusjfoskfoskfdoqwkdw', 'jdiewhrfiewkodwf', 'jediwjfiwqkdowkfw', 'qwjdwhfuedoqwkdiw', '1', NULL, 'kelly_01_07@hotmail.com', 3, 4, 1),
  (30, 'iuodhjsaddas', 'lakjsdkjlasdkjl', 'lkasd', 'ñlakñlsad', 'laksdj', '1', NULL, 'ce@hotmail.com', 2, 3, 1),
  (31, 'kfddfs', 'kjljdkjljladskjadskl', 'kjldsakjldkjldas', 'ñkadskñdskñlsadkñl', 'kasdkldkñlasdkñlds', '1', NULL, 'c@hot.com', 4, 3, 2),
  (32, 'jkladskjlsadkjl', 'ladkjsjlkads', 'ñkdskñlsdkñl', 'ñlkdskñldskñl', 'kldskñldskñlds', '1', NULL, 'c@hoy.com', 4, 3, 1);
