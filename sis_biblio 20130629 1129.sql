...
-- Script date 29/06/2013 11:29:10 a.m.
...
INSERT INTO tbl_componente VALUES 
  (75, 'holaaaaaaa asdasdasd', 'cersa'),
  (77, 'Cesar Nicho', 'kjasjkdsa'),
  (83, 'cesar nícho', ''),
  (84, 'asdjlk', ''),
  (86, 'asdasd', ''),
  (87, 'lkskjlsdfkjl', 'kljasjlkadskjlsad');
...
INSERT INTO tbl_rol VALUES 
  ...
  (79, 'KARINA', 'KELLY'),
  (80, 'hola', 'hola'),
  (81, 'dsf.-sd.f-s.f-dsfsf', ''),
  (82, 'dsf.-sd.f-s.f-dsfsf', ''),
  (83, 'joerrrrrrrrrrrrrrrrrrrrrrr-.-.-.', ''),
  (84, 'hola123124%7B%7D%7B%7D', 'asdasdasd'),
  (85, '', '');
