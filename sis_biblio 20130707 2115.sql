...
-- Script date 07/07/2013 09:15:28 p.m.
...
--
-- Definition for procedure SPRCCNSComponenteAccion
--
CREATE PROCEDURE SPRCCNSComponenteAccion(IN pIdCns TINYINT, IN pIdComponente INT, IN pLimit INT)
BEGIN
  IF pIdCns=1 THEN
SELECT
  tblc.id_componente,
