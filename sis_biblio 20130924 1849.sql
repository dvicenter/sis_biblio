...
-- Script date 24/09/2013 06:50:06 p.m.
...
--
CREATE PROCEDURE SPRINSTesis(IN pIdAutorInterno1 BIGINT, IN pIdDocente BIGINT,IN pTitulo VARCHAR(300),IN pIntroduccion TEXT,IN pObjetivo TEXT,IN pResumen TEXT,IN pConclusion TEXT,IN pAnio YEAR,IN pNumeroPagina SMALLINT,IN pCodigoMaterialBibliografico VARCHAR(40),IN pIdAutorInterno2 BIGINT,IN pIns CHAR(1))
BEGIN
