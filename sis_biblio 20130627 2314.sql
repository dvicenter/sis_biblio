...
-- Script date 27/06/2013 11:15:38 p.m.
...
ELSE
 ...
 IF pIdAbm=2
      THEN
      UPDATE tbl_componente set componente=pComponente, descripcion_componente=pDescripcion_componente WHERE id_componente=pId_componente;
      COMMIT;
      ELSE 
 IF pIdAbm = 3
      THEN
